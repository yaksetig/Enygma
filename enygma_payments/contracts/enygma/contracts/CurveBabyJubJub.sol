...
library CurveBabyJubJub {
    ...
    // GX/GY: NUMS hash-to-curve derivation, seed "2" (H-11 fix — the prior
    // GX/GY had no published derivation, an unfalsifiable trust gap since
    // whoever chose it could have picked G = e*H for a retained e).
    // Reproduce with: cd gnark-server && go run ./cmd/derive_generator
    uint256 private constant GX =
        12337812418750581066638756637363471856433191340622504180842886595232027947307;
    uint256 private constant GY =
        15225366398330386329633463986700597127113326976080712967801565482915963669722;
