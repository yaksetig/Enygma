...
func (c *GnarkClient) Erc1155FungibleWithBrokerV1Proof(
	...
	// Statement is built in non-interleaved format (no ContractStatement() needed):
	// [msg, tree0, tree1, root0, root1, null0, null1, cmt0, cmt1, cmt2, blindedPk, commRate, assetTreeNum, assetRoot]
	statement := make([]*big.Int, 0)
...
func prepareErc1155ProofParams(
	...
	for i := 0; i < len(keysOut); i++ {
		// recipientViewEncapKeys[i] is mandatory for non-interactive note delivery.
