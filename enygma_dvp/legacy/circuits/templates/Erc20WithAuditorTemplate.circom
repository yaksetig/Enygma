...
include "Erc20Template.circom";

template Erc20WithAuditorTemplate(
    tm_nInputs, 
    tm_mOutputs, 
    tm_merkleTreeDepth, 
    tm_range) {

    var plainLength = tm_nInputs + tm_mOutputs + 1;
    ...
    component cp_coinProof = Erc20Template(
        tm_nInputs, 
        tm_mOutputs, 
        tm_merkleTreeDepth, 
        tm_range
    ...
    cp_coinProof.wt_erc20ContractAddress <== wt_erc20ContractAddress;
    ...
    cp_auditorAccess.wt_values[tm_nInputs + tm_mOutputs] <== wt_erc20ContractAddress;    
